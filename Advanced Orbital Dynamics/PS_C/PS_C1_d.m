...
tolerance = 1e-12;
max_iterations = 1000;
% Add checks for singularities or areas where you divide by 0
% Add checks for zero derivatives
% Add checks for divergence (where the update value is not converging)
% Add check for max iterations. Add check to see that it matches Jacobi constant.
...
% Plot the ZVC
zvc_plot = scatter(zvc_table, 'x', 'y', 'SizeData', 5, 'MarkerFaceColor','#53A1C9', 'MarkerEdgeColor', '#53A1C9');
