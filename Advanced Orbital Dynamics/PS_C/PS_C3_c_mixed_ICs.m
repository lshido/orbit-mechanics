...
xlabel("x [non-dim]")
ylabel("y [non-dim]")
legend([L4_plot, zvc, linear_orbit, nonlinear_orbit], {'L4', 'ZVC', 'Linear Orbit', 'Nonlinear Orbit'})
title({['L4 Mixed frequency (x-y), \xi_0=', num2str(xi_0)]; ['JC=', num2str(C),', t=',num2str(t_end),'rad (Lillian Shido)']})
box on
grid on
fontsize(14, 'points')