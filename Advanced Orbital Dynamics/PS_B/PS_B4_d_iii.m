...
legend([sc, earth, moon, L1_plot, L2_plot], {'Spacecraft', 'Earth', 'Moon', 'L1', 'L2'})
title({"Trajectory of spacecraft approaching the Moon in the Earth-Moon system";"Problem B4(d.iii), Lillian Shido"})
