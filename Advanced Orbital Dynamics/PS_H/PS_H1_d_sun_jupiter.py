...
from methods import calc_velocity_from_Jacobi, planar_ode, system_properties, calc_L1, calc_L2, calc_ZVC_Jacobi
from constants import mu_Sun, mu_Jupiter, a_Jupiter


mu, l_char, t_char, x_Sun, x_Jupiter = system_properties(mu_Sun, mu_Jupiter, a_Jupiter)
x_L1, y_L1 = calc_L1(mu)
x_L2, y_L2 = calc_L2(mu)
JC_L1 = calc_ZVC_Jacobi(mu, x_L1, y_L1)
JC_L2 = calc_ZVC_Jacobi(mu, x_L2, y_L2)
print(f"L1 Jacobi: {JC_L1}")
print(f"L2 Jacobi: {JC_L2}")
pdb.set_trace()
JC = 3.0
# x (will be chosen)
y = 0 # Fixed
